function [A,point,Rt,focal]=generate_input_data(n,std_noise,draw_plot)
...
%add noise
for i=1:n
%     point(i).Ximg(1,1)=point(i).Ximg_true(1)+randn*std_noise;
%     point(i).Ximg(2,1)=point(i).Ximg_true(2)+randn*std_noise;
    point(i).Ximg(1,1)=point(i).Ximg_true(1);
    point(i).Ximg(2,1)=point(i).Ximg_true(2);
    point(i).Ximg(3,1)=f;
