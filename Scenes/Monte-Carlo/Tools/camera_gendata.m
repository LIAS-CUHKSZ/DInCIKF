...
function [camera_data] = camera_gendata(CAM_INTRISIC,lm_camera,t,p_camera_in_IMU_real,R_camera_in_IMU_real,dt, tc, p0, k)
    feature_in_camera=[];
    time=tc;
    time_sp=0;
    nn=1;
    ...
    sigma_tc=CAM_INTRISIC.sigma_tc;
    fx=CAM_INTRISIC.fx;
    fy=CAM_INTRISIC.fy; 
    cx=CAM_INTRISIC.cx;
    cy=CAM_INTRISIC.cy; 
